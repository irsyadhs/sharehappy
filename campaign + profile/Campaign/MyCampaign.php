...
<body>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Main row -->
      <div class="box box-success" style="width:85%; margin-left: 7.5%; height: 700px;">
      ...
      <div class="col-md-4" style="width: 40%;">
          <!-- Widget: user widget style 1 -->
             ...
             <a href="<?php echo base_url()?>newcampaign" class="btn btn-block btn-success btn-flat">Create New Campaign</a>
            
          <!-- /.widget-user -->
      </div>
      </div>
      <div class="row" style="margin-left:15%; margin-top: 10px;">
      ...
      <div class="col-md-4" style="width: 40%;" >
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-header bg-aqua-active">
              <a href="#" class="widget-user-username" style="color: white;">Campaign Mari Berbagi</a><br>
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header">35 HARI</h5>
