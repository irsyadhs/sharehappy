      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu menu-open">
            <li class="current"><a href="<?php echo base_url(); ?>Profile/MyInfo" style="color:#ffffff;">Profil Saya</a></li>
      ...
      <div class="box box-success" style="width:85%; margin-left: 7.5%; min-height: 600px;">
        <center><h3 class="box-title">Profil Saya</h3></center>
          <form class="form-horizontal" style="padding-left: 50px; padding-right: 50px;">       
            <div class="box-body">
              <center><img src="<?php echo base_url(); ?>assets/images/avaselector.png" class="avatar img-circle" alt="avatar">
