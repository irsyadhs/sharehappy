...
<body>
      ...
      <!-- sidebar menu: : style can be found in sidebar.less -->
        ...
        <div class="user-panel" style="padding-top: 0;">
          <div>
            ...
            <center><h5 class="pumpkin">dari target Rp. 19.975.000</h5>
            </center>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h2 class="box-title">Donasi Offline</h2>
      <div class="box box-warning" style="width:85%; margin-left: 7.5%; min-height: 600px;">
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jumlah Donator offline</span>
        ...
        <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Donasi Offline</span>
      ...
      <div class="col-md-4" style="width: 40%;">
          <!-- Widget: user widget style 1 -->
             ...
             <a href="<?php echo base_url()?>Campaign/TambahDonasiOffline" class="btn btn-block btn-warning btn-flat">Tambah Donasi Offline</a>
