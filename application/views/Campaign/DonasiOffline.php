  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-success" style="width:85%; margin-left: 7.5%; min-height: 600px;">
        <center><h3 class="box-title">Donasi Offline</h3></center>
        <br>
      ...
      <div class="col-md-4" style="width: 40%;">
          <!-- Widget: user widget style 1 -->
             ...
             <a href="<?php echo base_url()?>Campaign/TambahDonasiOffline" class="btn btn-block btn-success btn-flat">Tambah Donasi Offline</a>
