      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>Campaign/ListDonatur" style="color:#ffffff;">List Donatur</a></li>
    ...
    <section class="content">
     ...
     <!-- <div class="row">
      ...
      <div class="box box-success" style="width:85%; margin-left: 7.5%; height: 600px;">
        ...
        <table class="table" style="width: 90%; margin-left: 5%;margin-right: 5%; font-size: 19px;">
                <tr >
